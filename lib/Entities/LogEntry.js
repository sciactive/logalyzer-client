(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "Nymph", "NymphEntity", 'ua-parser-js', 'request'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("Nymph"), require("NymphEntity"), require('ua-parser-js'), require('request'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Nymph, global.NymphEntity, global.uaParserJs, global.request);
    global.LogEntry = mod.exports;
  }
})(this, function (exports, _Nymph, _NymphEntity, uaParser, request) {
  "use strict";
  ...
  class LogEntry extends _NymphEntity2.default {
      ...
      ipDataCache[ip] = new Promise((resolve, reject) => {
        ...
        function fallback() {
          ...
          request(ipInfoUrl, function (err, response, body) {
            ...
            var _body$split = body.split(';', 4),
                _body$split2 = _slicedToArray(_body$split, 4);

            const result = _body$split2[0],
                  countryCode = _body$split2[1],
                  unused = _body$split2[2],
                  country = _body$split2[3];
